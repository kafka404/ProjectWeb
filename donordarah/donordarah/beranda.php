...
<body>
      ...
      <div class="row g-4">
        <div class="col-md-4">
          <div class="card h-100 shadow-sm p-4 border-0">
            ...
            <p>Darah Anda bisa menjadi penyelamat bagi pasien yang membutuhkan transfusi.</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100 shadow-sm p-4 border-0">
            ...
            <p>Donor darah rutin membantu memperbarui sel darah dan menjaga kesehatan jantung.</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100 shadow-sm p-4 border-0">
            ...
            <p>Tindakan kecil Anda menunjukkan rasa kemanusiaan yang besar bagi orang lain.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="cta text-center text-light py-5">
    <div class="container">
      ...
      <p class="mb-4">Gabung bersama ribuan relawan yang siap membantu sesama melalui DonorDarah.</p>
