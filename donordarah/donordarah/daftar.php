...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $stmt = $conn->prepare("
    ...
    (nama, nomor_wa, pekerjaan, riwayat_penyakit, gaya_hidup, tinggi_badan, berat_badan, jenis_kelamin, tanggal_lahir, alamat, daerah)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  ");
          ...
          <div class="card shadow p-4 border-0">
            ...
            <form method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="daerah" class="form-control" placeholder="Contoh: Sleman, Yogyakarta">
              </div>
